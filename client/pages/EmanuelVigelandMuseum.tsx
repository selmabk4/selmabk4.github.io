        ...
        <section className="py-16 sm:py-24">
          ...
          <div className="lg:flex lg:items-start lg:gap-12">
            ...
            <div className="relative h-[360px] w-full max-w-[420px] lg:w-[420px] lg:shrink-0">
              {[
                ["804c4de5f06f40e1aca4774ef375ed2b", "Ekskursjon ved Emanuel Vigeland Museum", "left-[2%] top-[-55px] rotate-[-8deg]"],
                ["3296dc351d334508bf9a87f2c2c742f7", "Interiør fra Emanuel Vigeland Museum", "left-[27%] top-[-65px] rotate-[4deg]"],
                ["836da0e5234541a8ba359830c85840ef", "Detalj fra museet", "right-[2%] top-[-57px] rotate-[8deg]"],
                ["20c16f964831427fb466246aa26a920b", "Inngang til museet", "left-[8%] top-[125px] rotate-[5deg]"],
                ["2276d8c78980409bb193cf2087c72fee", "Emanuel Vigeland Museum utvendig", "left-1/2 top-[100px] -translate-x-1/2 rotate-[-4deg]"],
                ["dcbc8502002a4585bd325fb8a143dd8f", "Detalj fra museets interiør", "right-[6%] top-[130px] rotate-[7deg]"],
